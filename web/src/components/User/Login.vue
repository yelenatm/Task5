            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="user-block">
                        ...
                        <h1 class="user-block__header">Войти</h1>
                        ...
                        <div class="user-block__content">
                            <form v-on:submit.prevent autocomplete="off">
                                <div
                                    ...
                                    >
                                    <div class="form-group__message" v-if="$v.credentials.username.$error">Пожалуйста, введите имя пользователя.</div>
                                </div>
                                ...
                                <div
                                    ...
                                    >
                                    <div class="form-group__message" v-if="$v.credentials.password.$error">Пожалуйста, введите пароль.</div>
                                </div>
                                ...
                                >
                                    ...
                                    <span v-else>Войти <i class="fa fa-long-arrow-right"></i></span>
                                </button>
